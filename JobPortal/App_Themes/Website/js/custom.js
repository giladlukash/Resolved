(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        //FETCH NAVGIATION
        //$(document).ready(function () {
        //    fetch('/api/NavigationAllJobs')
        //        .then(res => res.json())
        //        .then(res => {
        //            $('#jobNav').html('')
        //            $.each(res, function (v, i) {
        //                //DO WHATEVER
        //                $('#jobNav').append('<li class="parent"><a href="/jobs/' + slugify(i.Title) + '"><i class="fas fa-square"></i>' + i.Title + '</a></li>');
        //                $('#sectorNav').append('<li class="parent"><a href="#"><i class="fas fa-square"></i>' + i.Title + '</a></li>');
        //            })
        //        })
        //})
